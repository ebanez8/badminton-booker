...
const valid: BookingRequest = { activity: 'Badminton', date: '2099-09-20', time: '19:00', courtPreferences: ['Court 03-AC-Badminton'], allowAnyCourt: false, releaseRule: { mode: 'offset-hours', offsetHours: 48 } }
